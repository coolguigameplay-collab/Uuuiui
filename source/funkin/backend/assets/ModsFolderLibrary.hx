...
// Require both MOD_SUPPORT and the 'sys' target to be active for file system access
#if (MOD_SUPPORT && sys)
import sys.FileStat;
...
class ModsFolderLibrary extends AssetLibrary implements IModsAssetLibrary {
    ...
    // HTML5 / Non-Sys Fallbacks
    // Because HTML5 cannot read local directories dynamically, these safely return empty/null
    // allowing the game to compile and run without breaking interfaces.
    
    public var _parsedAsset:String = null;
    
    public function getEditedTime(asset:String):Null<Float> return null;
    
    public override function getAudioBuffer(id:String):AudioBuffer return null;
    public override function getBytes(id:String):Bytes return null;
    public override function getFont(id:String):Font return null;
    public override function getImage(id:String):Image return null;
    
    public override function getPath(id:String):String return null;
    
    public inline function getFolders(folder:String):Array<String> return [];
    public inline function getFiles(folder:String):Array<String> return [];
    
    public override function exists(asset:String, type:String):Bool return false;
    public override function list(type:String):Array<String> return [];
